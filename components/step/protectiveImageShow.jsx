...
const ProtectiveImageShow = ({ opt }) => {
    return (
        <motion.div
            ...
            className="mt-6 bg-white p-4 border border-gray-200 shadow-xl w-[70vw] md:w-[440px] h-fit z-50">
            <div className="clipPath bg-gray-300 w-6 h-6 absolute md:rotate-90 top-0 md:top-10 right-10 md:right-0 translate-x-[100%]" />
            <div>
